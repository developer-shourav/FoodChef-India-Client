...
const Login = () => {
  ...
  const notify = () =>
    toast.error("Sorry 😓, Facebook login isn't working. Please try others");
    ...
    <div className="container  mx-auto">
      <div className="w-11/12 mx-auto">
        <h2 className="text-3xl font-bold text-center mt-10">
          {" "}
          <RiShieldKeyholeFill className="text-red-600 text-5xl md:text-4xl lg:text-6xl inline" />{" "}
          Please Login
        </h2>
            ...
            <div className="card flex-shrink-0 w-full rounded-lg max-w-sm shadow-stone-400 shadow-md  bg-base-100">
              <form onSubmit={handleEmailPassSignIn} className="card-body p-5">
                ...
                <div className="form-control mt-6">
                  ...
                  >
                    {" "}
                    <BsKeyFill className="me-1 text-xl" /> Login{" "}
                  </button>
                </div>
                ...
                <button
                  ...
                  className="btn normal-case bg-white mb-1   text-black rounded hover:bg-slate-200 google-btn-shadow border-0"
                >
                  {" "}
                  <img className="w-6 me-2" src={GoogleImg} alt="" /> Login with
                  Google
                </button>

                <button
                  onClick={handleGitHubLogin}
                  className="btn normal-case text-white mb-1   bg-black rounded  shadow-sm border-0"
                >
                  {" "}
                  <BsGithub className=" text-2xl me-2" /> Login with GitHub
                </button>

                <button
                  onClick={notify}
                  className="btn normal-case bg-blue-600 mb-1  text-white rounded hover:bg-blue-500  shadow-sm border-0"
                >
                  {" "}
                  <FaFacebookF className=" text-2xl me-1" /> Login with Facebook
                </button>
